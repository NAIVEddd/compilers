...
A_exp MakeQueensTig()
{
    ...
    A_exp op_nnm1 = A_OpExp(nilPos, A_minusOp, A_OpExp(nilPos, A_plusOp, v_N, v_N), A_IntExp(nilPos, 1));
    ...
    A_exp op_nm1 = A_OpExp(nilPos, A_minusOp, v_N, ei_0);
    ...
    A_exp efor_printboardI = A_ForExp(nilPos, s_i, ei_0, op_nm1, A_SeqExp(nilPos, A_ExpList(efor_printboardJ, A_ExpList(A_CallExp(nilPos, s_print, A_StringExp(nilPos, "\\n")), NULL))));
